<div align="center">
  <img src="./assets/BG_PHOTO.png" width="100%" alt="Mark Angel Concina — Full-stack developer" />
  <br />
</div>
...
<table>
  <tr>
    <td width="50%" valign="top">
      <h3>MC.AI</h3>
      <p>MC.AI is an AI document assistant that turns PDF, DOCX, and TXT files into searchable knowledge with grounded answers.</p>
      <p><code>React</code> <code>NestJS</code> <code>Langchain</code> <code>AstraDB</code> <code>Gemini</code></p>
      <p><a href="https://mc.ai.mcanghel.fun"><strong>Live experience ↗</strong></a> · <a href="https://github.com/kingsmark16/mc.ai">Source</a></p>
    </td>
    <td width="50%" valign="top">
      <h3>📼 CollegeRage</h3>
  ...
  <tr>
    <td width="50%" valign="top">
      ...
      <p><a href="https://github.com/kingsmark16/Redis-caching-rate-limiter-with-nestjs"><strong>Source</strong></a></p>
    </td>
    <td width="50%" valign="top">
      <h3>💌 Confession</h3>
